...
// Helper functions
async function getSalesCycleMetrics(where) {
...
async function getGeographicPerformance(where) {
...
async function getBrandPerformance(where) {
...
async function getConversionRates(where) {
